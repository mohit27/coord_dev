...
<form action="/consultant/home/client_view/<?php echo $query[0]->client_id;?>" method="post">
	...
	<div class="panel">
		<a href="/consultant/home/clients">Contacts</a> > <a href="/consultant/home/client_edit/<?php echo $query[0]->client_id;?>">Edit Contact</a>
							...
							<div class="span4">
								...
								<div class="sub-panel-record-field-edit">
									...
									<select id="gender" name="gender" style="width: 100px" autocomplete="off">
										<option <?php if($query[0]->gender == "not_set") echo "selected"; ?> >Unknown</option>
								...
								<div class="sub-panel-record-field-edit">
									<label class="sub-panel-record-field-edit" style="float: left; width: 110px;" for="date_of_birth">DOB</label>
									<input class="sub-panel-record-field-edit" id="date_of_birth" type="text" value="<?php echo $query[0]->date_of_birth; ?>" maxlength="255" name="date_of_birth" autocomplete="off">
								</div>
								<div class="sub-panel-record-field-edit">
									<label class="sub-panel-record-field-edit" style="float: left; width: 110px;" for="age">Age</label>
									<input class="sub-panel-record-field-edit" id="age" type="text" value="<?php echo $query[0]->age; ?>" maxlength="255" name="age" autocomplete="off">
								</div>
							</div>
							<div class="span4">
								<div class="sub-panel-record-field-edit">
									<label class="sub-panel-record-field-edit" style="float: left; width: 110px;" for="height">Height(in/cm)</label>
									<input class="sub-panel-record-field-edit" id="height" type="text" value="<?php echo $query[0]->height; ?>" maxlength="255" name="height" autocomplete="off">
								</div>
								<div class="sub-panel-record-field-edit">
									<label class="sub-panel-record-field-edit" style="float: left; width: 110px;" for="waist">Waist(in/cm)</label>
									<input class="sub-panel-record-field-edit" id="waist" type="text" value="<?php echo $query[0]->waist; ?>" maxlength="255" name="waist" autocomplete="off">
								</div>
								<div class="sub-panel-record-field-edit">
									<label class="sub-panel-record-field-edit" style="float: left; width: 110px;" for="weight">Start weight(lb/kg)</label>
									<input class="sub-panel-record-field-edit" id="start_weight" type="text" value="<?php echo $query[0]->start_weight; ?>" maxlength="255" name="start_weight" autocomplete="off">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row-fluid">
						<div class="span12">
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseMedical">
								<h2 class="sub-panel">Medical Information</h2>
							</a>
						</div>
					</div>
				</div>
